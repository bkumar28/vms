...
SECRET_KEY = "django-insecure-3ol8ffa58@)&q@st@x^@cc_hv%q%_94w7jt$k^+4_i6)mc#)y$"
...
SPECTACULAR_SETTINGS = {
    ...
    "APIs for effective management of vendor profiles, purchase orders & generating vendor performance matrix.",
    "VERSION": "1.0.0",
    "SERVE_INCLUDE_SCHEMA": False,
    "SWAGGER_UI_SETTINGS": {
        "displayOperationId": True,
    },
    "CONTACT": {"email": "kumar.bhart28@gmail.com"},
